export const CONFIG = {
  ...
  // Stream provider templates - matching your working JS version
  STREAM_PROVIDERS: {
    // TV Show providers (matching original working code)
    ...
    // Movie providers (matching original working code)
    ...
    // Anime providers (matching original working code)
