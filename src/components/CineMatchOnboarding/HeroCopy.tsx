...
export function HeroCopy({ minSelections }: Props) {
  return (
    <div className="max-w-2xl mb-6 px-5 sm:mb-12 sm:px-6">
      <h1 className="text-[28px] sm:text-5xl md:text-6xl font-bold tracking-tight mb-2.5 sm:mb-5 leading-[1.15]">
        What do you love watching?
      </h1>
      <p className="text-[15px] sm:text-lg md:text-xl text-zinc-400">
        Select at least{' '}
